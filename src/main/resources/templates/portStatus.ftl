                        ...
                        <table cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse;width: 100%;">
                           <tr>
                              <td class="title" align="left" style="border-width: 0;font-family: Arial, Helvetica, sans-serif;text-align: left;font-size: 42px;font-weight: bold;color: #ffffff;">
                                 <p align="left" style="background-color: #004F6C;margin: 0 15px 0; font-size: 42px;line-height: 1.5;font-weight: 700;bold;color: #ffffff;">Port status </p>
                              </td>
                           </tr>
                        </table>
                     ...
                     <td class="content" bgcolor="#ffffff" align="left" style="border-width: 0;font-family: Arial, Helvetica, sans-serif;background-color: #ffffff;padding: 40px 20px 20px 20px;text-align: left;">
                        <table cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse;max-width: 440px;width: 100%;">
                           <tr>
							  ...
							  <p style="margin: 0 0 15px 0;">${curDate}<br/>${stationStatus}<br/>${status}</p>
                                    ...
                                    <tbody>
                                       <tr>
                                          <td style="font-family: Arial, Helvetica, sans-serif;background: #05A1C6;padding:10px;box-sizing:border-box;">
                                             <h2 style="margin:0; color: white;font-size: 16px;font-weight: 700;">Port details</h2>
                                          </td>
                                       </tr>
                                    </tbody>
                                 </table>
                                 <table cellspacing="0" cellpadding="0" border="0" bgcolor="#f5f3f2" style="background:#f5f3f2;width:100%;">
                                    <tbody>
                                       <tr>
                                          <td bgcolor="#f5f3f2" style="font-family: Arial, Helvetica, sans-serif;width: 160px;box-sizing: border-box;padding: 5px 10px;gap: 4px;border-right: 1px solid #FFF; border-bottom: 1px solid #FFF; background: #f5f3f2;">Charger ID:</td>
                                          <td bgcolor="#f5f3f2" style="font-family: Arial, Helvetica, sans-serif;font-weight: 700; padding: 5px 10px;gap: 4px;border-right: 1px solid #FFF; border-bottom: 1px solid #FFF; background: #f5f3f2;">${StationId}</td>
                                       </tr>
									   <tr>
                                       <td bgcolor="#f5f3f2" style="font-family: Arial, Helvetica, sans-serif;width: 160px;box-sizing: border-box;padding: 5px 10px;gap: 4px;border-right: 1px solid #FFF; border-bottom: 1px solid #FFF; background: #f5f3f2;">Connector ID:</td>
                                       <td bgcolor="#f5f3f2" style="font-family: Arial, Helvetica, sans-serif;font-weight: 700; padding: 5px 10px;gap: 4px;border-right: 1px solid #FFF; border-bottom: 1px solid #FFF; background: #f5f3f2;">${connectorId}</td>
                                       </tr>
                                       <tr>
                                          <td bgcolor="#f5f3f2" style="font-family: Arial, Helvetica, sans-serif;width: 160px;box-sizing: border-box;padding: 5px 10px;gap: 4px;border-right: 1px solid #FFF; border-bottom: 1px solid #FFF; background: #f5f3f2;">Error code:</td>
                                          <td bgcolor="#f5f3f2" style="font-family: Arial, Helvetica, sans-serif;font-weight: 700; padding: 5px 10px;gap: 4px;border-right: 1px solid #FFF; border-bottom: 1px solid #FFF; background: #f5f3f2;">${errorCode}</td>
                                       </tr>
									   <tr>
                                       <td bgcolor="#f5f3f2" style="font-family: Arial, Helvetica, sans-serif;width: 160px;box-sizing: border-box;padding: 5px 10px;gap: 4px;border-right: 1px solid #FFF; border-bottom: 1px solid #FFF; background: #f5f3f2;">Vendor Error Code:</td>
                                       <td bgcolor="#f5f3f2" style="font-family: Arial, Helvetica, sans-serif;font-weight: 700; padding: 5px 10px;gap: 4px;border-right: 1px solid #FFF; border-bottom: 1px solid #FFF; background: #f5f3f2;">${vendorErrorCode}</td>
                                       </tr>
                                    </tbody>
                                 </table>
								  </td>

   ...
   <body style="margin: 0; padding: 0;">
      <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse; width: 600px;">
         ...
         <td style="padding: 0in 10pt;" xml="lang" class="">
            ...
            <p class="" style="text-align: left; font-size: 11pt; font-family: Calibri, sans-serif; margin-bottom: 7.5pt; line-height: 18.75pt;"><span style="font-size: 15pt; font-family: Arial, sans-serif; color: black;" class="">Your reservation has been cancelled successfully. </span></p>			
                                       ...
                                       <td style="padding: 0in;" xml="lang" class="">
                                          <table class="" style="width: 100%;" border="0" cellspacing="0" cellpadding="0">
                                             <tbody class="" style="">
                                                <tr class="" style="">
                                                   <td style="padding: 0in;" xml="lang" class="">
                                                      <p class="" style="margin: 0;; margin-left: 0in; font-size: 11pt; font-family: Calibri, sans-serif; text-align: left; line-height: 18.75pt;"><span style="font-size: 15pt; font-family: Arial, sans-serif; color: black;" class="">Cancellation Fee: </span></p>
                                                   </td>
                                                   <td style="padding: 0in;" xml="lang" class="">
                                                      <p class="" style="margin: 0in; margin-left: 0in; font-size: 11pt; font-family: Calibri, sans-serif;  text-align: right; line-height: 18.75pt;" align="right"><span style="font-size: 15pt; font-family: Arial, sans-serif; color: black;" class="">${cancellationFee} </span></p>
                                                   </td>
                                                </tr>
                                             </tbody>
                                          </table>

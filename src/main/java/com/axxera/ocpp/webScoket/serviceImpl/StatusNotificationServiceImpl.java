			...
			if(multipleReq) {
				...
				try {
					...
					if (stationObj.size() > 0) {
						...
						if (statusNoti.getStatus().equalsIgnoreCase("Unavailable") || !scheduledMaintenanceService.isInScheduledMaintenance(portUniId)) {
							System.err.println("Not in Scheduled Maintenance");
							if (portUniId > 0) {
